...
public class InstanceOperationTrackerTest {
    ...
    public void acceptsNewOperations() {
        ...
        InstanceOperationTracker.InstanceOperation instanceOperation1 = new InstanceOperationTracker.InstanceOperation(
                "instance1", "zone1", "prefix1", "1234");
        InstanceOperationTracker.InstanceOperation instanceOperation2 = new InstanceOperationTracker.InstanceOperation(
                "instance2", "zone2", "prefix2", "5678");
        InstanceOperationTracker.InstanceOperation instanceOperation3 = new InstanceOperationTracker.InstanceOperation(
                "instance3", "zone3", "prefix3", "abcd");

        instanceOperationTracker.add(instanceOperation1);
        instanceOperationTracker.add(instanceOperation2);

        Set<InstanceOperationTracker.InstanceOperation> instanceOperations = instanceOperationTracker.get();
    ...
    public void removesCompletedOperations() throws Exception {
        ...
        ComputeClientV2 clientV2 = Mockito.mock(ComputeClientV2.class);
        Mockito.when(cloud.getProjectId()).thenReturn("test-project");
        Mockito.when(cloud.getClientV2()).thenReturn(clientV2);
