...
public class InstanceOperationTrackerTest {
    ...
    public void removesCompletedOperations() throws Exception {
        ...
        Mockito.when(client2.getZoneOperation("test-project", "zone1", "1234")).thenReturn(zoneOperationsGetOperation1);
        Operation zoneOperationsGetOperation2 = Mockito.mock(Operation.class);
        Mockito.when(client2.getZoneOperation("test-project", "zone2", "5678")).thenReturn(zoneOperationsGetOperation2);
        Operation zoneOperationsGetOperation3 = Mockito.mock(Operation.class);
        Mockito.when(client2.getZoneOperation("test-project", "zone3", "abcd")).thenReturn(zoneOperationsGetOperation3);
